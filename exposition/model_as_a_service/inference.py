...
def predict_endpoint():
    ...
    model = joblib.load('/home/jovyan/work/Formation-MLOps-2/models/20200616-140746.joblib')
    received_data_df_processed = prepare_features(received_data_df, training_mode=False)
    prediction = model.predict(received_data_df_processed)
